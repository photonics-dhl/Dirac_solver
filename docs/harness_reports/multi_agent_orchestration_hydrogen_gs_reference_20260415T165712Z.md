...
- JSON: docs/harness_reports/multi_agent_orchestration_hydrogen_gs_reference_20260415T165712Z.json

## Invocation

```bash
python scripts/run_multi_agent_orchestration.py --api-base http://127.0.0.1:3001 --harness-base http://127.0.0.1:8001 --case-id hydrogen_gs_reference --max-iterations 1 --octopus-molecule H --octopus-calc-mode gs --skills-manifest /data/home/zju321/.openclaw/workspace/projects/Dirac/orchestration/agent_skills_manifest.json
```
