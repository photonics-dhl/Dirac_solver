...
|---|---|---:|---:|---:|---:|---:|:---:|:---:|---|:---:|---|
| n_atom_gs_official | E1 | - | - | - | -1.0 | 0.03 | False | True | - | False | ground_state_energy_hartree,benchmark_delta.relative_error |

## Source Artifact

- JSON: docs/harness_reports/multi_agent_orchestration_n_atom_gs_official_20260504T143510Z.json
